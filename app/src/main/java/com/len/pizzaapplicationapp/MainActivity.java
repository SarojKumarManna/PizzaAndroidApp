package com.len.pizzaapplicationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner list;
    String data[] = {"Cheese Burst", "Standard Italian Pizza",
            "Pepperoni pizza","Onion Herbs","Chicken Delight Pizza",
            "Capsicum Cheese Burst","Olive pizza","Muzarela Pizza"};
